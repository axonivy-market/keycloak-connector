...
public class AuthenticatorConfigRepresentation {
  ...
  public AuthenticatorConfigRepresentation id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public AuthenticatorConfigRepresentation alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  **/
  ...
  public AuthenticatorConfigRepresentation config(Map<String, String> config) {
    this.config = config;
    return this;
  }
