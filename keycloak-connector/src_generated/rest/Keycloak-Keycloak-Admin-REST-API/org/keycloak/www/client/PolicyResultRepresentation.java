...
public class PolicyResultRepresentation {
  ...
  public PolicyResultRepresentation policy(AdminrealmsAdminPermissionsClientAuthorizationSettingsPolicies policy) {
    this.policy = policy;
    return this;
  }
  ...
  **/
  ...
  public PolicyResultRepresentation status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public PolicyResultRepresentation associatedPolicies(List<PolicyResultRepresentation> associatedPolicies) {
  ...
  **/
  ...
  public PolicyResultRepresentation scopes(List<String> scopes) {
    this.scopes = scopes;
    return this;
  }
