...
public class ProtocolMapperRepresentation {
  ...
  **/
  ...
  public ProtocolMapperRepresentation consentRequired(Boolean consentRequired) {
  ...
  **/
  ...
  public ProtocolMapperRepresentation consentText(String consentText) {
  ...
  **/
  ...
  public ProtocolMapperRepresentation config(Map<String, String> config) {
    this.config = config;
    return this;
  }
