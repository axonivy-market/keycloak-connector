...
public class InstancesAliasBody {
  @JsonProperty("alias")
  ...
  public InstancesAliasBody alias(String alias) {
    this.alias = alias;
    return this;
  }
  ...
  **/
  ...
  public InstancesAliasBody displayName(String displayName) {
  ...
  **/
  ...
  public InstancesAliasBody internalId(String internalId) {
  ...
  **/
  ...
  public InstancesAliasBody providerId(String providerId) {
  ...
  **/
  ...
  public InstancesAliasBody enabled(Boolean enabled) {
  ...
  **/
  ...
  public InstancesAliasBody updateProfileFirstLoginMode(String updateProfileFirstLoginMode) {
  ...
  **/
  ...
  public InstancesAliasBody trustEmail(Boolean trustEmail) {
  ...
  **/
  ...
  public InstancesAliasBody storeToken(Boolean storeToken) {
  ...
  **/
  ...
  public InstancesAliasBody addReadTokenRoleOnCreate(Boolean addReadTokenRoleOnCreate) {
  ...
  **/
  ...
  public InstancesAliasBody authenticateByDefault(Boolean authenticateByDefault) {
  ...
  **/
  ...
  public InstancesAliasBody linkOnly(Boolean linkOnly) {
  ...
  **/
  ...
  public InstancesAliasBody hideOnLogin(Boolean hideOnLogin) {
  ...
  **/
  ...
  public InstancesAliasBody firstBrokerLoginFlowAlias(String firstBrokerLoginFlowAlias) {
  ...
  **/
  ...
  public InstancesAliasBody postBrokerLoginFlowAlias(String postBrokerLoginFlowAlias) {
  ...
  **/
  ...
  public InstancesAliasBody organizationId(String organizationId) {
  ...
  **/
  ...
  public InstancesAliasBody config(Map<String, String> config) {
    this.config = config;
    return this;
  }

  public InstancesAliasBody putConfigItem(String key, String configItem) {
    if (this.config == null) {
  ...
  **/
  ...
  public InstancesAliasBody updateProfileFirstLogin(Boolean updateProfileFirstLogin) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InstancesAliasBody instancesAliasBody = (InstancesAliasBody) o;
    return Objects.equals(this.alias, instancesAliasBody.alias) &&
        Objects.equals(this.displayName, instancesAliasBody.displayName) &&
        Objects.equals(this.internalId, instancesAliasBody.internalId) &&
        Objects.equals(this.providerId, instancesAliasBody.providerId) &&
        Objects.equals(this.enabled, instancesAliasBody.enabled) &&
        Objects.equals(this.updateProfileFirstLoginMode, instancesAliasBody.updateProfileFirstLoginMode) &&
        Objects.equals(this.trustEmail, instancesAliasBody.trustEmail) &&
        Objects.equals(this.storeToken, instancesAliasBody.storeToken) &&
        Objects.equals(this.addReadTokenRoleOnCreate, instancesAliasBody.addReadTokenRoleOnCreate) &&
        Objects.equals(this.authenticateByDefault, instancesAliasBody.authenticateByDefault) &&
        Objects.equals(this.linkOnly, instancesAliasBody.linkOnly) &&
        Objects.equals(this.hideOnLogin, instancesAliasBody.hideOnLogin) &&
        Objects.equals(this.firstBrokerLoginFlowAlias, instancesAliasBody.firstBrokerLoginFlowAlias) &&
        Objects.equals(this.postBrokerLoginFlowAlias, instancesAliasBody.postBrokerLoginFlowAlias) &&
        Objects.equals(this.organizationId, instancesAliasBody.organizationId) &&
        Objects.equals(this.config, instancesAliasBody.config) &&
        Objects.equals(this.updateProfileFirstLogin, instancesAliasBody.updateProfileFirstLogin);
  }
  ...
  public String toString() {
    ...
    sb.append("class InstancesAliasBody {\n");
