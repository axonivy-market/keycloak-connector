...
public class RealmEventsConfigRepresentation {
  ...
  public RealmEventsConfigRepresentation eventsEnabled(Boolean eventsEnabled) {
  ...
  **/
  ...
  public RealmEventsConfigRepresentation eventsExpiration(Long eventsExpiration) {
  ...
  **/
  ...
  public RealmEventsConfigRepresentation eventsListeners(List<String> eventsListeners) {
  ...
  **/
  ...
  public RealmEventsConfigRepresentation enabledEventTypes(List<String> enabledEventTypes) {
  ...
  **/
  ...
  public RealmEventsConfigRepresentation adminEventsEnabled(Boolean adminEventsEnabled) {
  ...
  **/
  ...
  public RealmEventsConfigRepresentation adminEventsDetailsEnabled(Boolean adminEventsDetailsEnabled) {
