...
public class ProcessPaths {
  ...
  public static final String ROLE_SUB_PROCESSES = "connector/Roles";
  public static final String GET_ROLES_START_NAME = "getRoles";
  ...
  public static final String ROLES_RESULT = "roles";
}
